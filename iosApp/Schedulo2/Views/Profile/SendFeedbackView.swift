...
final class FeedbackViewModel: ObservableObject {
    ...
    func submit(category: FeedbackCategory, description: String, steps: String, screenshot: UIImage?) {
        ...
        guard FeedbackLimits.isValidDescription(description) else {
        ...
        guard FeedbackLimits.isValidSteps(steps) else {
            errorMessage = "Steps to reproduce is too long (max \(FeedbackLimits.maxSteps) characters)."
            return
        }
